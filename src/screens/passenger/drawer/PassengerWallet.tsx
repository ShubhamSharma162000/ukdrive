...
import { getPassengerDetail, getPassengerTransaction } from '../PassengerQuery';
import { useAuth } from '../../../context/AuthContext';
import AddMoneyModal from '../utils/AddMoneyModal';
...
export default function PassengerWallet() {
  ...
  const { data: passengerTransaction } = useQuery({
    queryKey: ['transactions', id],
    queryFn: () => getPassengerTransaction(id),
    staleTime: 0,
    gcTime: 5 * 60 * 1000,
    refetchOnMount: false,
    refetchOnWindowFocus: false,
      ...
      >
        ...
        >
          <View>
            ...
            >
              {passengerData?.data?.walletBalance}
            </Text>
          </View>
          <View
            sx={{
