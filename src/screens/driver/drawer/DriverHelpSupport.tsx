...
const faqData = [
  ...
  },
  {
    ...
    answer:
      'Payments are sent directly to your registered bank account. You can view your daily and weekly earnings in the app "Earnings" section.',
    tag: 'Payment',
    color: '#e0e7ff',
    textColor: '#1e40af',
  },
          ...
          {['faq', 'contact', 'emergency'].map(tab => (
            <TouchableOpacity
              ...
              style={{
                flex: 1,
                backgroundColor:
                  activeTab === tab ? '#b34df7ff' : 'transparent',
                paddingVertical: 12,
                alignItems: 'center',
              }}
            >
              ...
              >
                <TouchableOpacity onPress={() => toggleExpand(index)}>
                  ...
                  >
                    ...
                    <Text sx={{ fontSize: 18, color: '#b34df7ff', ml: 10 }}>
                      ▼
                    </Text>
                  </View>
                </TouchableOpacity>
